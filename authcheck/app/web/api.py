...
class ctime_convert():
    def convert(self):
        ...
        print("Workspace ctime is " + str(converttime))
        return converttime
...
def workspace():
    ...
    ws = Workspace(depart_name=depart_name, cname=session['username'], system_name=system_name, ctime=ctime_convert().convert())
    ws.save()
